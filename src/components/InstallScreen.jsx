                ...
                <Page>
                    ...
                    <Block>
                        <Card>
                            <CardContent>
                                <p>
                                    PWA «Радонеж» — это прогрессивное веб-приложение, которое может работать на различных устройствах и не зависит от магазинов приложений.
                                </p>
                                {(isInstallable || isIphone) && (<p>Установите его на своё устройство, чтобы легко и удобно слушать любимые передачи!</p>)}
                                {isIphone && (
                                    <>
                                        <br />
                                        <ol>
